        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Focus</h4>
              <p>
                Designing, building, and deploying automated ML pipelines and real-time inference engines. Implementing model monitoring, drift detection, and automated retraining workflows.
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Kubeflow</div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Focus</h4>
              <p>
                Architecting scalable, low-latency distributed systems, streaming feature pipelines, and microservices. Optimizing cache layers, databases, and deploying robust cloud infrastructures.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
